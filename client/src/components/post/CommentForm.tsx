...
export default function CommentForm() {
  ...
  return (
    <form
      ...
      className="p-5 w-full flex justify-between items-center gap-3 bg-contain bg-center bg-[url('/assets/img/bg_wood_dark.png')] border-[3px] border-brown-70 rounded-lg common-drop-shadow">
      <CommentProfileImage location="add" />
      <input
