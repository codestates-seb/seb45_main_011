...
export default function ControlMenu({
  ...
  return (
    <div
      className={`relative group w-[34px] h-[34px] bg-brown-50 border-2 border-brown-70 rounded-[50%] common-drop-shadow hover:scale-105 transition-transform ${BUTTON_STYLE[usage].container}`}>
      <Image
