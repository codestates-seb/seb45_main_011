...
export default function CommentProfileImage() {
  ...
  return (
    <div className="min-w-[38px] w-[44px] h-[44px] rounded-[50%] flex justify-center items-center border-brown-10 border-[3px] overflow-hidden max-[560px]:w-[38px] max-[560px]:h-[38px] max-[500px]:hidden">
      <Image
