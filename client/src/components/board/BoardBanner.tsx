...
export default function BoardBanner() {
  ...
  return (
    <div>
      <div className="py-[1.375rem] px-[2.75rem] w-full h-[132px] min-w-[328px] max-w-[720px] flex justify-between items-center gap-5 bg-[url('/assets/img/bg_grass.png')] bg-cover shadow-outer/down border-[6px] border-green-90 rounded-xl mb-2 max-[688px]:py-[1rem] max-[688px]:px-[1rem] max-[432px]:h-[108px]">
        ...
        <div className="flex flex-col gap-3 items-center justify-between text-center max-[432px]:gap-1">
          ...
          <p className=" text-[2rem] leading-10 font-bold text-white-10 banner-text-shadow common-drop-shadow max-[752px]:text-2xl max-[415px]:text-[1.175rem]">
            <b className=" text-[2.5rem] text-yellow-50 max-[752px]:text-[2rem] max-[480px]:text-[2rem] max-[432px]:text-[1.35rem]">
