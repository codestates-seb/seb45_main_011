...
export default function PlantCard({ usage, plantInfo }: PlantCardProps) {
  ...
  return (
    <li
      ...
      />
      <h3 className="text-base text-brown-90 leading-4">
        {PLANT_CARD_CONTENTS[name]}
      </h3>
      <p className="text-xs text-brown-70 leading-3">
        {PLANT_SIZES[getPlantSize(name)]}
      </p>
      {usage === 'shop' && (
        <p
      ...
      <CommonButton usage="button" size="sm" className="mt-[10px]">
