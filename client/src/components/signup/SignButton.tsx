...
export default function SignButton() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-[url('/assets/img/bg_board_md.png')] w-[320px] h-[224px] shadow-outer/down max-[432px]:scale-75 max-[432px]:-my-4-6">
