...
public interface ChatMessageService {
    ...
    ChatMessageResponseDto createEnterMessage(EnumChatRoomRequestDto chatMessageRequest);
    ChatMessageResponseDto sendExitChatRoomMessage(EnumChatRoomRequestDto deleteChatRoomRequest);
}
